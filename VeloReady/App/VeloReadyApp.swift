...
struct VeloReadyApp: App {
    ...
    init() {
        ...
        Task { @MainActor in
            ...
            TodayComponentRegistry.shared.register(FTPComponent.self)
            TodayComponentRegistry.shared.register(VO2MaxComponent.self)
            TodayComponentRegistry.shared.register(AIBriefComponent.self)
