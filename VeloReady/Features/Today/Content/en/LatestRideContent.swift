...
/// Content strings for the Latest Activity panel
enum LatestRideContent {
    // MARK: - Header
    static let title = "Latest Activity"  /// Panel title
    ...
    // MARK: - Empty States
    static let noActivities = "No recent activities"  /// No activities message
