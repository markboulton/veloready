        ...
        VStack(spacing: 0) {
            ...
            LinearGradient(
                gradient: Gradient(stops: [
                    .init(color: Color.background.app.opacity(0.7), location: 0.0),
                    .init(color: Color.background.app.opacity(0.5), location: 0.3),
                    .init(color: Color.background.app.opacity(0.3), location: 0.6),
